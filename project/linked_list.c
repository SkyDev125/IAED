...
/// Global variable for managing parks.
...
/**
 * @brief Function to get the total number of parks in the linked list.
 *
 * @return The total number of parks.
 */
park_index get_parks() { return parks; }
...
void show_parks() {
	...
	for (int i = 0; i < parks.park_num; i++) {
		printf(
